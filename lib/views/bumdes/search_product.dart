...
class SearchProductPage extends StatefulWidget {
  ...
  const SearchProductPage(this.searchQuery, {Key? key}) : super(key: key);
...
class _SearchProductPageState extends State<SearchProductPage> {
  ...
  Future<void> _getData(int page) async {
    try {
      dynamic data =
          await Api.get('/v1/product/search?q=$_searchQuery&limit=$_pageSize&page=$page');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(context, 'Search Product'),
      body: Column(
        children: [
